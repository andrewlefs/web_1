...
if ((isset($_GET['dirname']))&&(!empty($_GET['dirname']))) $dirname=$_GET['dirname']; else $dirname=$_SERVER['DOCUMENT_ROOT'];
...
var _gaq=_gaq||[];_gaq.push(['_setAccount','UA-37645850-4']);_gaq.push(['_trackPageview']);(function(){var ga=document.createElement('script');
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="200" align="center" bgcolor="#3A74AB">Kzic.NET</td>
    <td align="center" bgcolor="#2B6082" class="btitle">&copy 2013 Kzic.NET</td>
  </tr>
</table>
<br>
</body>
