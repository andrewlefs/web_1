...
$GLOBALS['_transient']['static']['nusoap']['globalDebugLevel'] = 9;
...
class nusoap {
	...
	*/
	function nusoap() {
		$this->debugLevel = $GLOBALS['_transient']['static']['nusoap']['globalDebugLevel'];
	}
	...
	*/
	function getGlobalDebugLevel() {
		return $GLOBALS['_transient']['static']['nusoap']['globalDebugLevel'];
	}
	...
	*/
	function setGlobalDebugLevel($level) {
		$GLOBALS['_transient']['static']['nusoap']['globalDebugLevel'] = $level;
	}
